...
DEFS := -DNDEBUG -DHEADLESS -DSOFTGPU_ONLY -DHTTPS_NOT_AVAILABLE \
        ...
        -D_7ZIP_ST -DZ7_ST -DCHIMERA_WATERBOX

INCS := -I$(PP) -I$(PP)/Common -I$(PP)/ext -I$(PP)/ext/zlib \
...
EXT_SRCS := \
        ...
        $(wildcard $(PP)/ext/libchdr/deps/lzma-24.05/src/*.c) \
